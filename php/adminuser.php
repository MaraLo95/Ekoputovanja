  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <a href="admin/destroysesion.php" style="color:black;" type="button" class="btn btn-light">Odjava</a>
        ...
        <div class="col-md-12">
            ...
            <input type="text" onkeyup="searchusers(this.value)" class="form-control" placeholder="Pretrazi...">
          </div>
...
<table>
  ...
  for(let i=0;i<spisakzaposlenih.length;i++)
  {
    ...
    <tr>
      ...
      <td class="text-right"> <input name="delete" type="submit"  class="btn btn-success mx-4" value="Obrisi"></td>
    </tr>
